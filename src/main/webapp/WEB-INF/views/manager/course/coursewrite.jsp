...
<body>
						...
						<section class="panel">
							...
							<div class="panel-body">
								<form role="form" action="/manager/course/coursewrite"
									...
									<div class="form-group">
										<label for="cprice">요금</label> <input type="text"
											name="cprice" id="cname" class="form-control"
	...
	<script type="text/javascript">
		...
		function selectOverlay(type) {
			...
			var db = manager.select(daum.maps.drawing.OverlayType[type]);
		}
