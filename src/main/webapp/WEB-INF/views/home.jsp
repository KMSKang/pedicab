...
<head>
<title>Home</title>
<%@ include file="user/commons/indexbg.jsp" %>
</head>
<body>
<%@ include file="user/commons/Header.jsp" %>
			...
			<div class="row">
				...
				<div class="col-md-6">
					<div class="search-wrap-1 ftco-animate p-4">
						<h1 style="color:white;text-align:center;">Team150(Pedicab)</h1>
					</div>
				</div>
					<div class="col-md-3">
				</div>
...
<%@include file="user/commons/footer.jsp" %>
</body>
</html>
