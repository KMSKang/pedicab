...
public class ReserveController {
	 ...
	 * ===============================
	 * 
	 * 리스트=listAll SELECT * FROM 테이블명
	 * 
	 * ==============================
	 * 
	 * 하나만보기=view(매니저페이지M,유저페이지U) SELECT * FROM 테이블명 WHERE seq = ?
	 * 
	 * ==============================
	 * 
	 * 삭제=remove DELETE FROM 테이블명 WHERE seq = ?
	 * 
	 * ==============================
	 * 
	 * 수정=modify UPDATE 테이블명 SET VALUES(?=?,?=?) WHERE seq=?
	 * 
	 * =============================
	 */
	...
	@RequestMapping("/user/payment/userpayment")
